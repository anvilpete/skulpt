...
class NonCallableMock(Base):
    ...
    def _mock_add_spec(self, spec, spec_set, _spec_as_instance=False,
        ...
        if spec is not None and not _is_list(spec):
            ...
            ## Skulpt: no mock_add_spec (requires inspect module)
            raise NotImplementedError("mock_add_spec is not yet implemented in Skulpt")
...
class _patch(object):
    ...
    def __init__(
        ...
        ## Skulpt: no patch (requires contextlib.ExitStack)
        raise NotImplementedError("patch is not yet implemented in Skulpt")
...
def create_autospec(spec, spec_set=False, instance=False, _parent=None,
    ...
    ## Skulpt: no create_autospec (requires inspect module)
    raise NotImplementedError("create_autospec is not yet implemented in Skulpt")
...
def mock_open(mock=None, read_data=''):
    ...
    """
    ## Skulpt: no mock_open (requires io module)
    raise NotImplementedError("mock_open is not yet implemented in Skulpt")
